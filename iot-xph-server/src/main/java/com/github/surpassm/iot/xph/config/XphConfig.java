package com.github.surpassm.iot.xph.config;
 ...
 */
public class XphConfig {

    @Data
    @AllArgsConstructor
    @NoArgsConstructor
    @Component
    @ConfigurationProperties(prefix = "spring.modbus.server")
	...
	@NoArgsConstructor
	@Component
	@ConfigurationProperties(prefix = "spring.modbus.server.cache")
